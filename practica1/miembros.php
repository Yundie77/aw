...
<main>
  ...
  <section id="miembro1">
    ...
    <img src="img/vahram.jpg" alt="Foto de Vahram Saakian" width="150">
  ...
  <section id="miembro2">
    <h2>Yundie Wang</h2>
    <img src="img/yundie.jpg" alt="Foto de Yundie Wang" width="150">
  ...
  <section id="miembro3">
    ...
    <img src="img/natalia.jpg" alt="Foto de Natalia Pego Martínez" width="150">
  ...
  <section id="miembro4">
    <h2>Hua de Wu Lin</h2>
    <img src="img/hua.jpg" alt="Foto de Hua de Wu Lin" width="150">
  ...
  <section id="miembro5">
    <h2>Junhua Li Li</h2>
    <img src="img/junhua.jpg" alt="Foto de Junhua Li Li" width="150">
