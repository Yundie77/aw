...
class Aplicacion
{
    ...
    {
        $this->compruebaInstanciaInicializada();
        return $this->usuarioLogueado() && (array_search(Usuario::rol, $_SESSION['roles']) !== false);
    }
     */
     ...
     * @param mixed  $valor Valor a almacenar como atributo de la petición.
     *
     */
     ...
     *
     * @return mixed Attributo asociado a la sesión bajo la clave <code>$clave</code> o <code>null</code> si no existe.
     */
